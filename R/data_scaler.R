...
#' @param initial.imp The method for initial imputation. Can be "mean", "median" or "sample" (default).
...
#' @param x a vector
#' @param lower The lower quantile (25% by default)
#' @param upper The upper quantile (75% by default)
#' @export
