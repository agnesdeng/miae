...
vae.decoder<-nn_module(
  "vae.decoder",
  initialize = function(n.others, cardinalities,hidden.dropout, latent.dim, decoder.structure, act) {
...
vae.encoder.decoder<-nn_module(
  initialize=function(categorical.encoding, n.others, cardinalities, embedding.dim,
                      input.dropout, hidden.dropout, encoder.structure, latent.dim, decoder.structure, act){
    self$Encoder<-vae.encoder(categorical.encoding, n.others, cardinalities, embedding.dim,
                              input.dropout, hidden.dropout, encoder.structure, latent.dim, act)
