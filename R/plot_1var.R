#' Overlapped density plots for multiply imputed values for a single numeric variable
...
#' @importFrom ggplot2 ggplot aes vars geom_density facet_grid labs scale_color_manual scale_fill_manual guides theme element_text
